...
#define SDCARD_D0_GPIO       (2U)
#define SDCARD_D1_GPIO       (4U)
#define SDCARD_D2_GPIO       (12U)
#define SDCARD_D3_GPIO       (13U)
#define SDCARD_CMD_GPIO      (15U)
#define SDCARD_CLK_GPIO      (14U)
